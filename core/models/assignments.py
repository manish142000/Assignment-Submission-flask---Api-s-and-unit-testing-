...
class Assignment(db.Model):
    ...
    def grading(cls, _id, grade, principal: Principal):
        ...
        assertions.assert_valid(assignment.content is not None, 'assignment with empty content submitted')
        assertions.assert_valid(assignment.state is not AssignmentStateEnum.GRADED, 'Assignment is already graded')
        assertions.assert_valid(grade in valid_grades, 'Invalid Grade Submitted')
